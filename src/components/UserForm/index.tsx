import { Gender, Status } from '@api/types';
import { UserFormProps } from "./types";

export const UserForm: React.FC<UserFormProps> = ({ btnText, formik }) => {
    return (
        <form
        ...
        >
            ...
            {/* Validación cuando se va a editar un usuario */}
            {
                formik.values.id && (
                    <div className="block md:flex gap-4">
                        <div className="flex flex-col gap-2 w-full">
                            ...
                            <select
                                ...
                                className="px-4 py-2 bg-input border-inputstroke border rounded-lg text-text-title"
                            >
                                <option value={Status.Default}>Seleccionar género</option>
                                <option value={Status.Active}>Ativo</option>
                                <option value={Status.Inactive}>Inactivo</option>
                            </select>
                            {
            ...
            >
                ...
                <button
                    ...
                    type="submit"
                    className={`px-6 py-2 rounded-lg transform transition-transform duration-300 hover:scale-105 ${
